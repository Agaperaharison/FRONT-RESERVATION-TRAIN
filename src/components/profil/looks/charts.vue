...
<template>
    <div class="charts">
        ...
        <div class="container-chart">
            ...
            <div class="chart" v-for="Value in allSales" :key="Value.createdAt">
                <div class="chart-amount cht">
                    <span :style="{ height: ((Value.totalAmount * 100) / maxAmount) + '%' }"></span>
                </div>
                <div class="chart-paid cht">
                    <span :style="{ height: ((Value.paidAmount * 100) / maxAmount) + '%' }"></span>
                </div>
                <div class="chart-unpaid cht">
                    <span
                        :style="{ height: ((Value.unpaidAmount * 100) / maxAmount) !== 0 ? ((Value.unpaidAmount * 100) / maxAmount) + '%' : '0.1%' }"></span>
                </div>
            </div>
        </div>
    </div>
